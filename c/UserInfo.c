...
The struct takes 48 bytes of space. Rearrange the struct, without removing, renaming, or changing the type of the members,
so that it uses less memory. The code uses pointers to struct members, so struct should be properly aligned.
*/
